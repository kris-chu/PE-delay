...
def test(model, prob, num_bits):
    ...
    print('Test Loss: {:.6f}, Acc: {:.6f}'.format(eval_loss / len(test_data), float(eval_acc) / len(test_data)))
...
for epoch in range(1):
    # run('../change_Lossfunction/LeNet_forSingerNegative.pkl')
    run('../change_Lossfunction/LeNet_forSingerOppositeSign_Loss.pkl')
